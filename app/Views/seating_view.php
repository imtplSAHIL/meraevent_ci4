                ...
                <div>
                    ...
                    <div class="col-lg-12" id="LeftPaddCol">
                        <div id="WizardBox">
                            ...
                            <h1 class="level"><?php echo $ticketsData[$ticketids['Level-1']]['name']; ?> (<img src="https://content.meraevents.com/images/rupee-icon.gif" width="12" height="12" /> <?php echo $ticketsData[$ticketids['Level-1']]['price']; ?>)</h1>
                            <div class="seatplan">
                                <ul class="r">
                            ...
                            <h1 class="level"><?php echo $ticketsData[$ticketids['Level-2']]['name']; ?> (<img src="https://content.meraevents.com/images/rupee-icon.gif" width="12" height="12" /> <?php echo $ticketsData[$ticketids['Level-2']]['price']; ?>)</h1>
                            <div class="seatplan">
                                <ul class="r">
                            ...
                            <h1 class="level"><?php echo $ticketsData[$ticketids['Balcony']]['name']; ?> (<img src="https://content.meraevents.com/images/rupee-icon.gif" width="12" height="12"/> <?php echo $ticketsData[$ticketids['Balcony']]['price']; ?>)</h1>
                            <div class="seatplan">
                                <ul class="r">

    ...
    <div class="wrap">
        <div class="container"> 
            ...
            <form method="post" action="https://secure.ebs.in/pg/ma/payment/request/" name="frmTransaction" id="frmTransaction" >
                ...
                <input name="reference_no" value="<?php echo $txtCustomerID?>" type="hidden">
       
                <input name="return_url" type="hidden" value="<?php echo $returnUrl;?>" />
                 
                <input type='hidden' name='amount' value='<?php echo $txtTxnAmount?>' />
                <input type='hidden' name='description' value='<?php echo $eventTitle?>' />
                ...
                <input name="page_id" type="hidden" value="5952"/>

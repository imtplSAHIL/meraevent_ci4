    ...
    <div class="fs-form">
	    ...
	    <div class="editFields">
	        <form name="eventContactInfoForm" id="eventContactInfoForm" action="" method="post">
	            ...
	            <input type="text" name="eventContactEmail" id="eventContactEmail" class="textfield" value="<?php echo $contactDetails['contactemail']; ?>">
                    <label>Contact Number</label>
	            <input type="text" name="eventContactNumber" id="eventContactNumber" class="textfield" value="<?php echo $contactDetails['contactnumber']; ?>">
	            <label>Enter Name(s), Phone or Email</label>

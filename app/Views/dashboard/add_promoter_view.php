<div class="rightArea">
    ...
    <div class="editFields fs-add-promoter-form" <?php if($promoterId>0){ echo 'style="display:none;"';}?>>
        <form name='addPromoterForm' method='post' action='' id='addPromoterForm'>
            ...
            <input required="" min="1" max="80" type="text" class="textfield" name='commission' id='commission' value="<?php echo $affiliateCustomCommition;?>">
    ...
    <div class="editFields fs-add-promoter-form">
        <form>
            <?php if ($promoterId > 0) { ?>
                ...
                <div class="clearBoth"></div>
                <label>Commission (%)<span class="mandatory">*</span></label>
                <input type="text" class="textfield" name='commission' id='commission' value="<?php echo isset($promoterEventCommission)?$promoterEventCommission:'';?>" readonly>
                <div class="clearBoth"></div>
            <?php } 
			?>

...
<div class="rightArea">
    <div class="heading float-left">
        <h2> Past Attendee Marketing: <span><?php echo $eventName; ?> (<?php echo $eventId; ?>) </span></h2>
...
?>
    ...
    if($viral_enable){
        ?>
<!--    <form id="pastAttMarketing" method="post" action="">-->
<input type="hidden" name="eventId" id="eventId" value="<?=$eventId;?>">
    <div style="float:left;">
    <input <?php if($showSendEmail){ ?>style="display:none;" <?php } ?> type="button" class="createBtn float-right" name="past_att_send_mails" id="past_att_send_mails" value="Send Email to Attendees"/>
    </div>
     <div style="float:left; margin-left: 10px;">
        <a href="<?php echo commonHelperGetPageUrl('dashboard-uploadpastatt', $this->input->get('eventId')); ?>" class="createBtn float-right" name="upload_attendees" id="upload_attendees">Upload Attendees</a>

<div class="rightArea">
    ...
    <div class="refundSec discount"><!-- data-tablesaw-mode="swipe" -->
        <table width="100%" border="1" cellspacing="0" cellpadding="0"  data-tablesaw-minimap>
            <thead>
                <tr>
                    <th scope="col"  style="padding-left:2%;text-align:left;width:20% !important">Name</th>
                    <?php if($masterEvent == TRUE){ ?>
                        <th scope="col" data-tablesaw-priority="2" style="text-align:left;width:12% !important">Event Start Date</th>
                    <?php } ?>
                ...
                if ($discountList) {
                    ...
                    foreach ($discountList as $index => $row) {
                        ...
                        <tr <?php echo $class; ?> >
                            ...
                            <?php if($masterEvent == TRUE){ ?>
                                <td style="text-align:left !important;"><?php echo (isset($row['eventStartDate']))?allTimeFormats($row['eventStartDate'], 3):'All Dates'; ?></td>
                            <?php } ?>

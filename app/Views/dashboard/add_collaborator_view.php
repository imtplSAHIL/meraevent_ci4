<div class="rightArea">
    ...
    <div class="editFields fs-add-collaborator-form">
        <form id="addCollaborator" action="javascript:;">
            ...
            <input name="mobile" id="MobileNo" type="text" class="textfield mobileNo" value="<?php echo isset($collaboratorList) ? $collaboratorList['mobile'] : ''; ?>" />

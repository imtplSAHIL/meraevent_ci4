...
It connects organizers and attendees seamlessly, helping organizers list, promote and sell tickets all at one place and reach out to their target audience on an easy to use digital platform. We are a proud "Go-Green" initiative and we seek to make the entire event process paperless.
                        ...
                        <li  class="showmenu"><a href="javascript:;">How Can I Contact You?</a>
                            <!-- <p class="menu" style="display: none;">You can contact us on support@meraevents.com or call us on <b>040-49171447</b> for all your queries and redressal of grievances.</p> -->
                        ...
                        <li  class="showmenu"><a href="javascript:;">What support does MeraEvents provide?</a>
                            <!-- <p class="menu" style="display: none;">MeraEvents provides dedicated support via email and phone. Reach out to us at <a href="mailto:support@meraevents.com">support@meraevents.com</a> or call us on <b>040-49171447</b> for any queries and we will get back to you at the earliest.</p> -->
...
<li>Other customize solutions</li>
                        ...
                        <input type ="hidden" id="serviceTax" value="18"/>

                ...
                <div class="row">
                    <ul class="" role="tablist" id="myTab"><!--nav nav-tabs-->
                        <li role="presentation" class="active col-lg-4 col-md-6 col-sm-12 affiliate-tab text-center">
                            <a href="#findevents" aria-controls="findevents" role="tab" data-toggle="tab" aria-expanded="false">
                                <!-- <img src="<?php echo $this->config->item('images_static_path'); ?>affiliate/findevents-img.png"> -->
                                <div class="sprite-icon findevents-img"></div>
                        ...
                        <li role="presentation" class="col-lg-4 col-md-6 col-sm-12 affiliate-tab text-center">
                            <a href="#shareevent" aria-controls="shareevent" role="tab" data-toggle="tab" aria-expanded="true">
                                <!-- <img src="<?php echo $this->config->item('images_static_path'); ?>affiliate/shareevents-img.png"> -->
                                <div class="sprite-icon shareevents-img"></div>

                                <p class="aff-tab-subheading">Share Events</p></a>
                        </li>
                        <li role="presentation" class="col-lg-4 col-md-6 col-sm-12 affiliate-tab text-center">
                            <a href="#earnmoney" aria-controls="earnmoney" role="tab" data-toggle="tab" aria-expanded="true">

                                <!-- <img src="<?php echo $this->config->item('images_static_path'); ?>affiliate/earnmoney-img.png"> -->
                                <div class="sprite-icon earnmoney-img"></div>

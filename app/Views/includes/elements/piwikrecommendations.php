...
g.type="text/javascript"; g.async=true; g.defer=true; g.src="'.$this->config->item('images_cloud_path').'"+"js/piwik/piwik'.$jsExt.'"; s.parentNode.insertBefore(g,s);
})();
</script>
<noscript><p><img src="//piwik.stage.meraevents.com/piwik/piwik.php?idsite='.$idsite.'" style="border:0;" alt="" /></p></noscript>
<!-- //piwik.stage.meraevents.com/piwik/piwik.php?idsite='.$idsite.' g.src='.$this->config->item('images_cloud_path').'+"js/piwik/piwik'.$jsExt.'"; End Piwik Code -->';               	
echo $script;
?>
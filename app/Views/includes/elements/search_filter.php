...
<div id="locationContainer" class="locSearchContainer"  >
    ...
    <a class="btn collapsed categories collapse_bt hiddenfilter-lg hiddenfilter-md hiddenfilter-sm"
       ...
       aria-controls="collapseTwo"><span class="sprite-icon mobilefilters-category-icon hiddenfilter-lg hiddenfilter-md"></span>All Categories <span class="icon-downArrowH"></span></a>

    <a class="btn time collapsed collapse_bt hiddenfilter-lg hiddenfilter-md hiddenfilter-sm"
       href="#headerDD2" aria-expanded="false"
       aria-controls="collapseThree"> <span class="sprite-icon mobilefilters-date-icon hiddenfilter-lg hiddenfilter-md"> </span>All Time <span
    ...
    <div class="filterdiv hiddenfilter-sm hiddenfilter-xs" id="headerDD1" style="width: 100%;">
        <div class="accTextCont categoryList">
            <span class="floatR locSearchContainer btnClass"> <a
                    href="javascript:void(0)" class="btn">
                    <!-- <img src="<?php echo $this->config->item('images_static_path'); ?>close-icon.png"></a> -->
                    <div class="sprite-icon close-icon"></div>
            </span>
            ...
            <ul ng-init="init(<?php echo htmlspecialchars(json_encode($categoryList)); ?>, 'category')">
                ...
                <li ng-repeat="category in categoryList" id="{{category.id}}_category">
                    <a title="{{category.name}}"  ng-click="setFilter('category', category.id, category.name, 0, 0)" >
                        <i class="mecat-{{category.name|replaceSpaceFilterSearch |lowercase}} col{{category.name| replaceSpaceFilterSearch | lowercase}} "></i>       
...
<div id="locationContainerMobile" class="locSearchContainer">
    ...
    <a class="btn collapsed city collapse_bt hiddenfilter-lg hiddenfilter-md hiddenfilter-sm"
       href="#headerDD" aria-expanded="false" aria-controls="collapseOne"  ng-click="getEventCount('', 'city')" ng-init="defaultFilter()"> <span class="sprite-icon mobilefilters-city-icon hiddenfilter-lg hiddenfilter-md"></span><span  id="selectedCity"  class="cityClass" ><?php echo $defaultCityName; ?></span>
    ...
    <a class="btn collapsed categories collapse_bt hiddenfilter-lg hiddenfilter-md hiddenfilter-sm"
       href="#headerDD1" aria-expanded="false"
       aria-controls="collapseTwo" ng-click="getEventCount('', 'category')" ng-init="selectedCategoryId =<?php echo $defaultCategoryId; ?>"  ><span class="sprite-icon mobilefilters-category-icon hiddenfilter-lg hiddenfilter-md"></span><span class="categoryClass"  ><?php
    ...
    <a class="btn time collapsed collapse_bt hiddenfilter-lg hiddenfilter-md hiddenfilter-sm"
       ...
       aria-controls="collapseThree" ng-init="selectedCustomFilterId =<?php echo $defaultCustomFilterId; ?>;
               selectedCustomFilterName = '<?php echo $defaultCustomFilterName; ?>'" ng-click="getEventCount('', 'customFilter')"><span class="sprite-icon mobilefilters-date-icon hiddenfilter-lg hiddenfilter-md"> </span><span   class="CustomFilterClass"    ><?php echo $defaultCustomFilterName; ?></span>
    ...
    <a ng-click="getEventRegCount()" class="btn collapsed collapse_bt hiddenfilter-lg hiddenfilter-md hiddenfilter-sm" href="#headerDD33" aria-expanded="false" aria-controls="collapseFour" ng-cloak>
                         <span class="sprite-icon mobilefilters-webinar-icon hiddenfilter-lg hiddenfilter-md"> </span><span class="freepaid">{{typeName}}</span>&nbsp;<span class="icon-downArrowH"></span></a>
        <!--Mobile-->

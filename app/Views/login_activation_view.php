                         ...
                         <div class="form-group">  
                          ...
                          <?php   if($email){?>
                                  <input ng-change="hideErrorMsgs()" ng-model="resend.email" ng-required="true"  ng-init="resend.email='<?php echo $email; ?>'" 
                                         id="email" name="email" ng-pattern="/^([a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,10}$/" type="email" class="form-control userFields">
                            <?php }else{ ?>                         
                         <input ng-change="hideErrorMsgs()" ng-model="resend.email" ng-required="true" id="email" 
                                name="email" ng-pattern="/^([a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,10}$/" type="email" class="form-control userFields"  placeholder="Enter Your Email" 

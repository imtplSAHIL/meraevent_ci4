...
class Payment extends CI_Controller {
    ...
    public function paypalPrepare() {
        ...
        if ($currencyCode != 'USD') {
//            $get = file_get_contents("https://finance.google.com/finance/converter?a=" . $txtTxnAmount . "&from=" . $currencyCode . "&to=USD");
            $get = url_get_contents("https://finance.google.com/finance/converter?a=" . $txtTxnAmount . "&from=" . $currencyCode . "&to=USD");

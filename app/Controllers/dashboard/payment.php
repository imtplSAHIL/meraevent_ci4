...
class Payment extends CI_Controller {
    ...
    public function refund($eventId,$param2,$param3,$param4) {
        $inputArray['eventId'] = $eventId;
        ...
        if($param4 == "getRefundCount"){
            echo json_encode($data['refundOutput']); exit;
         }
         
        if($data['refundOutput']['response']['total'] == 0){
            redirect(commonHelperGetPageUrl('dashboard-myevent'));
        }

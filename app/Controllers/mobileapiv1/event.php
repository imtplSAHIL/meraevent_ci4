...
class Event extends REST_Controller {
    ...
    public function index_get() {
		...
		$eventDetails['response']['details']['startDate']=convertTime($eventDetails['response']['details']['startDate'],$eventDetails['response']['details']['location']['timeZoneName'],true);
		$eventDetails['response']['details']['endDate']=convertTime($eventDetails['response']['details']['endDate'],$eventDetails['response']['details']['location']['timeZoneName'],true);
	}

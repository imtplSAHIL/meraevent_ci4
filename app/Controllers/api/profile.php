...
class Profile extends REST_Controller {
    ...
    public function getUserTicketList_get() {
	...
	function isBankDetailsFilled_get() {

        $this->loginCheck();
		$bankdetailHandler=new Organizerbankdetail_handler();
        $isBankDetailsFilledResponse = $bankdetailHandler->isBankDetailsFilled();
        $resultArray = array('response' => $isBankDetailsFilledResponse['response']);
        $this->response($resultArray, $isBankDetailsFilledResponse['statusCode']);
    }
}

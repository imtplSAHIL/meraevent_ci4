...
class Dashboard extends REST_Controller {
    ...
    function getThirdPartyTransactions_post() {
        $inputArray = $this->input->post();
        $this->eventSignupHandler = new Eventsignup_handler();
        $apiTransactions = $this->eventSignupHandler->getThirdPartyTransactions($inputArray);
        $responseArray = array('data' => $apiTransactions['response']['searchData']);
        $this->response($responseArray, $output['statusCode']);
    }
}

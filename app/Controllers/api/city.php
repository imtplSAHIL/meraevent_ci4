...
class City extends REST_Controller {
    ...
    public function list_get() {
        ...
        // Check Version
        $appVersion = !empty($inputArray['APP_VERSION']) ? $inputArray['APP_VERSION'] : '';
        $appUpdate = ($appVersion != '' && $appVersion < '4.3') ? array('appUpdate' => 2) : array();
        $resultArray = array('response' => $cityList['response'] + $appUpdate);

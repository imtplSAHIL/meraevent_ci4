...
class Country extends REST_Controller {
    ...
    public function details_get() {
		...
		$details = $this -> countryHandler -> getCountryListById($inputArray);
                $participationticketdetails = $this->eventHandler->getParticipationType();
		$resultArray = array('response' => $details['response']['detail'], 'ticketsresponse' => $participationticketdetails['response']['participationTicketsList']);

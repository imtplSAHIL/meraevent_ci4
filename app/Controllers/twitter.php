...
class Twitter extends CI_Controller {
    ...
    public function redirect() {
		...
		if(defined('COUNTRY_URI')){
            $callback_url = $this->config->item('protocol'). $_SERVER['HTTP_HOST'] ."/".COUNTRY_URI. "/twitter/callback";
        }
        else{
            $callback_url = $this->config->item('protocol'). $_SERVER['HTTP_HOST'] . "/twitter/callback";   
        }
